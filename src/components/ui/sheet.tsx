...
const SheetContent = <
	T extends ValidComponent = "div" & { setNavigate: Setter<boolean> },
>(
	props: PolymorphicProps<T, DialogContentProps<T>>,
) => {
	const [local, others] = splitProps(
		props as DialogContentProps & { setNavigateBack: Setter<boolean> },
		["setNavigateBack", "position", "class", "children"],
	);
	return (
		<SheetPortal position={local.position}>
			<SheetOverlay onClick={() => local.setNavigateBack(true)} />
			...
			>
				...
				<SheetPrimitive.CloseButton
					onClick={() => local.setNavigateBack(true)}
